            ...
            <div class="container">
                ...
                <div class="row workDetails">
                    <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
                        <div class="workYear">Septembre 2015,<br>
                            Février 2016</div>
                    </div>
                ...
                <div class="row workDetails">
                    <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
                        <div class="workYear">Janvier 2013,<br>
                            Aujourd'hui</div>
                    </div>
                    <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 rightArea">
                        <div class="arrowpart"></div>
                        <div class="exCon">
                            ...
                            <p>
                              ...
                              Le projet à été selectionné parmis les 13 finalistes des Epitech Innovative Projects parmis plus de 100 projets.<br/>
                              J'ai pour ma part développé le frontend et le backend de l'application en Symfony avec un base de données Mongo, mise à disposition d'une Api pour les applications mobile.<br/>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="row workDetails">
                    <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
                        <div class="workYear">Avril 2011,<br>
                            Juillet 2014</div>
                    </div>
                    <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 rightArea">
                        <div class="arrowpart"></div>
...
Développement bundle Symfony association compte<br/>
Facebook, Twitter et Google+. Récupération, stockage et analyse de
données en tâches Cron.<br/>
Mise en place d'un serveur et développement d'un
bundle client, OAuth.</p>
                        </div>
                    </div>
                </div>
                <div class="row workDetails">
                    <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
                        <div class="workYear">Juillet 2012<br>
                            Décembre 2012</div>
                    </div>
                    <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 rightArea">
                        <div class="arrowpart"></div>
